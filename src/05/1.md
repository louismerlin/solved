...
The `wasm` is WebAssembly and contains the game logic (such as the 1000 point limit or what happens when I press buttons).
The `pck` contains the game assets, such as the images and text.
...
If you found an alternative way of getting to the flag, I would be happy to document it here, shoot me an email! 
