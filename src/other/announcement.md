...
Using this logic on the rest of the digits, you end up with an https URL, which gives us the flag, as well as a few hints for the [Kickstarter challenges](./kickstarter.html).